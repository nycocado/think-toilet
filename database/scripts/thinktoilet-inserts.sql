...
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_like, cmm_dislike, cmm_cdatetime) values (1, 'This restroom was impressively clean and accessible. Its spacious and well-maintained, perfect for wheelchair users!', 5, 5, 4, 4, 10, 2, NOW());
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_like, cmm_dislike, cmm_cdatetime) values (1, 'There was no toilet paper available during my visit. Otherwise, it seemed fine, but supply tracking needs improvement.', 3, 1, 3, 2, 8, 3, NOW());
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_like, cmm_dislike, cmm_cdatetime) values (2, 'The restroom was clean, but the hand dryer was broken, and I didnt find any paper towels. Regular checks are necessary.', 4, 5, 2, 3, 5, 1, NOW());
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_like, cmm_dislike, cmm_cdatetime) values (3, 'The restroom needs more attention; it was not very clean, with stains on the floor and an overflowing trash bin.', 2, 4, 2, 4, 6, 2, NOW());
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_like, cmm_dislike, cmm_cdatetime) values (4, 'Accessible but lacking supplies; no hand sanitizer and an empty soap dispenser. These details matter!', 4, 3, 4, 5, 7, 0, NOW());
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_like, cmm_dislike, cmm_cdatetime) values (5, 'Decent experience, but it could be cleaner, especially around the sinks where water accumulates.', 3, 2, 1, 1, 9, 4, NOW());
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_like, cmm_dislike, cmm_cdatetime) values (6, 'Great overall! Clean, well-stocked, and excellent accessibility features made my visit comfortable.', 5, 4, 5, 5, 12, 1, NOW());
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_like, cmm_dislike, cmm_cdatetime) values (5, 'Good accessibility but lacking in supplies. The paper towels were out, and the soap dispenser was low.', 3, 2, 2, 3, 4, 3, NOW());
